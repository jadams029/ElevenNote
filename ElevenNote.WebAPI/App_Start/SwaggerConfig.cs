...
namespace ElevenNote.WebAPI
{
    ...
    public class AddAuthorizationHeaderParameterOperationFilter : IOperationFilter
    {
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
            ...
            var isAutorized = filterPipeline
                .Select(filterInfo => filterInfo.Instance)
                .Any(filter => filter is IAuthorizationFilter);

            var allowAnonymous = apiDescription.ActionDescriptor.GetCustomAttributes<AllowAnonymousAttribute>().Any();

            if (!isAutorized || allowAnonymous) return;
    ...
    /// <summary>
    /// Document filter for adding OAuth Token endpoing documentation in Swashbuckle / Swagger
    /// Swagger won't normally find it - the /token endpoint - ude to it programatically generated.
    /// </summary>
